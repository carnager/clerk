...
menu_tool         = ["rofi", "-ballot-selected-str", "•", "-ballot-unselected-str", " ", "-kb-element-next", "", "-dmenu", "-matching", "regex", "-i", "-p", "PLACEHOLDER", "-multi-select", "-kb-row-tab", "", "-kb-move-word-forward", "", "-kb-accept-alt", "Tab", "-no-levensthein-sort"]
# fzf example
